...
public class TourRatingController {
     ...
     */
    @GetMapping
    public PagedResources<RatingDto> getAllRatingsForTour(@PathVariable(value = "tourId") int tourId, 
    													Pageable pageable,PagedResourcesAssembler<TourRating> pagedAssembler) {
